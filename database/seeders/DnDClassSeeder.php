...
class DnDClassSeeder extends Seeder
{
    ...
    {
        $classes = [
            ['name' => 'Artificer', 'description' => 'A master of invention, creating magical objects infused with arcane power.'],
            ...
            ['name' => 'Paladin', 'description' => 'A holy warrior bound to a sacred oath, wielding divine power to fight against evil.'],
